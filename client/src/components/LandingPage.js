            ...
            <div className="overlay-container">
                <div className="overlay">
                    <div className="overlay-panel overlay-left">
                        ...
                        <button onClick={removeClass} className="ghost landingPageButton" id="signIn"> SIGN IN! </button>
                    </div>
                    ...
                    <div className="overlay-panel overlay-right">
                        ...
                        <button onClick={addClass} className="ghost landingPageButton" id="signUp"> CREATE AN ACCOUNT! </button>
                    </div>
                </div>
            </div>
        </div>
